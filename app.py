...
st.caption("Upload the updated manpower file (TOTAL MANPOWER + LEFT sheets).")
...
if manpower_file is not None and st.button("🚀 Run reconciliation", type="primary"):
    ...
    with st.spinner("Reconciling..."):
        try:
            plan, output_bytes, change_log, summary_md, updated_mapping = reconcile.reconcile(master_bytes, manpower_file.read())
        except Exception as e:
